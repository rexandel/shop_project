...
public class UnitOfWork {
    ...
    public void bulkInsertOrders(List<Order> orders) throws SQLException {
        String sql = "INSERT INTO orders (customer_id, delivery_address, total_price_cents, total_price_currency, created_at, updated_at) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    public void bulkInsertOrderItems(List<OrderItem> items) throws SQLException {
        String sql = "INSERT INTO order_items (order_id, product_id, quantity, product_title, product_url, price_cents, price_currency, created_at, updated_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
